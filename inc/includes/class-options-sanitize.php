...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-cutsnstyle' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-cutsnstyle' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-cutsnstyle' ),
		'repeat'    => __( 'Repeat All', 'skt-cutsnstyle' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-cutsnstyle' ),
		'top center'    => __( 'Top Center', 'skt-cutsnstyle' ),
		'top right'     => __( 'Top Right', 'skt-cutsnstyle' ),
		'center left'   => __( 'Middle Left', 'skt-cutsnstyle' ),
		'center center' => __( 'Middle Center', 'skt-cutsnstyle' ),
		'center right'  => __( 'Middle Right', 'skt-cutsnstyle' ),
		'bottom left'   => __( 'Bottom Left', 'skt-cutsnstyle' ),
		'bottom center' => __( 'Bottom Center', 'skt-cutsnstyle' ),
		'bottom right'  => __( 'Bottom Right', 'skt-cutsnstyle')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-cutsnstyle' ),
		'fixed'  => __( 'Fixed in Place', 'skt-cutsnstyle')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-cutsnstyle' ),
		'italic'      => __( 'Italic', 'skt-cutsnstyle' ),
		'bold'        => __( 'Bold', 'skt-cutsnstyle' ),
		'bold italic' => __( 'Bold Italic', 'skt-cutsnstyle' )
		);
